...
int year2015_sol04(void);  // input is constant
...
int year2015_sol10(void);  // input is constant
int year2015_sol11(void);  // input is constant
...
int year2015_sol20(void);  // input is constant
int year2015_sol21(void);  // input is constant
